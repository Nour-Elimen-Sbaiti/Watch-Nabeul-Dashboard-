...
{/* Animated background orbs */}
        <div style={{
          ...
          height: "500px",
          borderRadius: "50%",
          background: "radial-gradient(circle, rgba(217, 119, 6, 0.40) 0%, transparent 70%)",
        ...
        <div style={{
          ...
          bottom: 0,
          backgroundImage: `
            linear-gradient(rgba(217, 119, 6, 0) 1px, transparent 1px),
            linear-gradient(90deg, rgba(101, 163, 13, 0.3) 1px, transparent 1px)
          `,
        ...
        <div style={{
          ...
          height: "450px",
          borderRadius: "50%",
          background: "radial-gradient(circle, rgba(101, 163, 13, 0.30) 0%, transparent 70%)",
          animation: "float 10s ease-in-out infinite reverse",
          pointerEvents: "none",
          zIndex: 0,
        }} />
        <div style={{
          ...
          height: "400px",
          borderRadius: "50%",
          background: "radial-gradient(circle, rgba(8, 145, 178, 0.30) 0%, transparent 70%)",
          animation: "float 12s ease-in-out infinite",
          pointerEvents: "none",
          zIndex: 0,
        }} />
        ...
        <div style={{
          ...
          backgroundImage: `
            linear-gradient(rgba(217, 119, 6, 0) 1px, transparent 1px),
            linear-gradient(90deg, rgba(101, 163, 13, 0.2) 1px, transparent 1px)
          `,
          backgroundSize: "80px 80px",
          opacity: 0,
          animation: "bgRotate 180s linear infinite",
